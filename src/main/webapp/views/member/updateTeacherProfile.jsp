					...
					<div class="container">
						<div class="header-wrap">
							...
							<div class="header-menu">
								<ul>
														...
														<div class="row row-xl-5">
															...
															<div class="col">
																...
																<ul>
																	...
																	<li><a href="#"> <span class="text">課程</span>
																		</a></li>
									...
									<c:if test="${member.teaqual == false}">
										<li><a href="<%=request.getContextPath()%>/views/member/regiTeacherProfile.jsp">
												<span class="text">申請成為教師</span> <span
									...
									<c:if test="${member.teaqual == true}">
										<li><a
												...
												<span class="text">教師中心</span> <span
													class="icon fa fa-angle-left"></span>
											</a></li>
									</c:if>
								</ul>
							...
							<div class="header-logo">
								<a href="<%=request.getContextPath()%>/index.jsp" class="primary-logo"> <span
							...
							<div class="sidenav-body-inner">
								<div class="sidenav-links">
									<a href="page-login.html" class="button button-md button-block button-line-primary">
										...
										class="button button-md button-block button-primary"> <span class="text">Sign
											Up</span>
									</a>
								</div>
								<ul>
									...
									<li class="has-menu"><a href="#"> <span class="text">All
										...
										<div class="mega-menu">
											...
											<ul class="sidenav-menu-ul">
												...
												<li><a href="page-single-post.html"> <span class="text">Single
															Post</span>
													</a></li>
												<li><a href="page-cooperation.html"> <span
															class="text">Cooperation</span>
														...
														<ul class="el-list-icon">
															...
															<li><a
																	...
																	<i class="fa fa-cog"></i> <span
																		class="text">基本資料</span>
																</a></li>
															<li>
																<%-- <a
																	href="<%=request.getContextPath() %>/views/member/updateTeacherSkills.jsp">
																	--%>
																	<a
																		href="<%=request.getContextPath() %>/views/member/getTeaSkills/id/${member.memid}">
																		<i class="fa fa-cog"></i> <span
																			class="text">專業資格</span>
																	</a>
															</li>
															<li><a
																	href="<%=request.getContextPath()%>/views/course/CourseOverview1.html">
																	<i class="fa fas fa-book"></i> <span
																		class="text">我的課程總覽</span>
																</a>
															</li>
															<li>
																<a
																	href="<%=request.getContextPath()%>/views/teacher/teacherSchedule.html">
																	<i class="fa fas fa-book"></i>
																	<span class="text">我的行事曆</span>
																</a>
															</li>
														</ul>
													</div>
										...
										<div class="col-12 col-sm-12 col-md-12 col-lg-8">
											<div class="el-panel">
												<div class="el-panel-body">
													...
													<!-- 上傳表單 -->
													<form class="form-3"
														action="<%=request.getContextPath()%>/views/member/teacherUpdate"
														...
														<div class="row row-sm">
																		...
																		<div class="avatar-preview">
																			<c:if test="${not empty member.photo}">
																				<c:set var="image" scope="page"
																					value="${member.photo}" />
																				<!-- 																<div id="imagePreview" -->
																				<%-- style="background-image: url(data:image/png;base64,<%=Base64.getEncoder().encodeToString((byte[]) pageContext.getAttribute("
																					image"))%>);"> --%>
																					<!-- 																</div> -->
																					<div id="imagePreview"
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-10">
																<div class="pr-15">
																	<div class="form-item">
																		...
																		<input name="eduid" type="hidden"
																			id="input-eduid" class="text-left"
																			value="${education.eduid}">
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-6">
																<div class="form-item">
																	...
																	<input name="username" type="text"
																		...
																		value="${member.username}"> <span class="error"
																		style="color: red;">
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-6">
																<div class="form-item">
																	<label for="input-email"
																		class="form-label">電話</label> <input
																		name="phonenum" type="text" id="input-phonenum"
																		class="text-left" value="${member.phonenum}">
																	<span class="error" style="color: red;">
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-6">
																<div class="form-item">
																	<label for="input-teatitle"
																		class="form-label">江湖稱號</label>
																	<input name="teatitle" type="text"
																		id="input-teatitle" class="text-left"
																		value="${param.teatitle}${member.teatitle}">
																	<span class="error" style="color: red;">
																		${errors.teatitle} </span>
																</div>
															</div>
															<!-- 儲存科目 -->
															<div class="col-12 col-sm-12 col-md-12 col-lg-6">
																<div class="form-item">
																	<label for="input-type"
																		class="form-label">科目</label>
																	<div class="input-select">
																		<%-- <input name="subjectid" type="number"
																			id="input-teatitle" class="text-left"
																			value="${member.subjectid}"> --%>
																			<select class="el-select2-select-hour"
																				name="subjectid" required>
																				<option value="">&nbsp;</option>
																				<option value="1001" <c:if
																					test="${subjectid == 1001 || member.subjectid == 1001}">
																					selected</c:if>>English</option>
																				<option value="1002" <c:if
																					test="${subjectid == 1002 || member.subjectid == 1002}">
																					selected</c:if>>Japanese</option>
																				<option value="1003" <c:if
																					test="${subjectid == 1003 || member.subjectid == 1003}">
																					selected</c:if>>Chinese</option>
																				<option value="1004" <c:if
																					test="${subjectid == 1004 || member.subjectid == 1004}">
																					selected</c:if>>Korean</option>
																				<option value="1005" <c:if
																					test="${subjectid == 1005 || member.subjectid == 1005}">
																					selected</c:if>>German</option>
																			</select> <span class="error"
																				style="color: red;">
																				${errors.subjectid} </span>
																	</div>
																</div>
															</div>
															...
															<div class="col-12 col-sm-12 col-md-12 col-lg-12">
																<div class="form-item">
																	<!-- 偷塞teaqual -->
																	<input type="hidden" name="teaqual"
																		value="${member.teaqual}" /> <label
																		for="input-description"
																		class="form-label">自介內容</label>
																	<textarea name="introcontent" id="input-description"
																		cols="30"
																		rows="10">${param.introcontent}${member.introcontent}</textarea>
																	<span class="error" style="color: red;">
																		${errors.introcontent} </span>
																</div>
															</div>
