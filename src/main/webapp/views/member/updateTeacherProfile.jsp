							...
							<div class="el-panel el-panel-teacher-widget">
								<div class="el-panel-body">
									...
									<ul class="el-list-icon">
										...
										<li><a
											href="<%=request.getContextPath()%>/views/member/updateTeacherProfile.jsp">
												<i class="fa fa-cog"></i> <span class="text">基本資料</span>
										</a></li>
										<li>
											...
											href="<%=request.getContextPath() %>/views/member/getTeaSkills/id/${member.memid}">
												<i class="fa fa-cog"></i> <span class="text">專業資格</span>
										</a>
										</li>
										<li><a
											href="<%=request.getContextPath()%>/views/member/teacherCourses.jsp">
												<i class="fa fas fa-book"></i> <span class="text">開設課程</span>
										</a></li>
									</ul>
								</div>
							</div>
								...
								<div class="el-panel-body">
									...
									<form class="form-3"
										...
										<div class="row row-sm">
													...
													<div class="avatar-upload">
														<div class="avatar-edit">
															...
															<input type="file" id="imageUpload"
																accept=".png, .jpg, .jpeg" name="image" /> <label
														...
														<div class="avatar-preview">
															<c:if test="${not empty member.photo}">
																...
																<div id="imagePreview"
																	style="background-image: url(data:image/png;base64,<%=Base64.getEncoder().encodeToString((byte[]) pageContext.getAttribute("image"))%>);">
																</div>
															</c:if>
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-6">
												<div class="form-item">
													...
													<input name="username" type="text" id="input-username"
														class="text-left" value="${member.username}"> <span
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-6">
												<div class="form-item">
													<label for="input-email" class="form-label">電話</label> <input
														name="phonenum" type="text" id="input-phonenum"
														class="text-left" value="${member.phonenum}"> <span
														class="error" style="color: red;">
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-6">
												<div class="form-item">
													...
													<input name="teatitle" type="text" id="input-teatitle"
														class="text-left"
														value="${param.teatitle}${member.teatitle}"> <span
														class="error" style="color: red;">
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-6">
												<div class="form-item">
													...
													<div class="input-select">
														...
														<select class="el-select2-select-hour" name="subjectid"
															required>
															<option value="">&nbsp;</option>
															<option value="1001"
																<c:if test="${subjectid == 1001 || member.subjectid == 1001}">selected</c:if>>English</option>
															<option value="1002"
																<c:if test="${subjectid == 1002 || member.subjectid == 1002}">selected</c:if>>Japanese</option>
															<option value="1003"
																<c:if test="${subjectid == 1003 || member.subjectid == 1003}">selected</c:if>>Chinese</option>
															<option value="1004"
																<c:if test="${subjectid == 1004 || member.subjectid == 1004}">selected</c:if>>Korean</option>
															<option value="1005"
																<c:if test="${subjectid == 1005 || member.subjectid == 1005}">selected</c:if>>German</option>
											...
											<div class="col-12 col-sm-12 col-md-12 col-lg-12">
												<div class="form-item">
													...
													<input type="hidden" name="teaqual"
														...
														for="input-description" class="form-label">自介內容</label>
													<textarea name="introcontent" id="input-description"
														cols="30" rows="10">${param.introcontent}${member.introcontent}</textarea>
