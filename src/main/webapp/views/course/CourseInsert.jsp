					...
					<div class="header-wrap">
						...
						<div class="header-menu">
							<ul>
								...
								<li><a href="<%=request.getContextPath()%>/views/member/updateTeacherProfile.jsp">
										<span class="text">老師中心</span> <span class="icon fa fa-angle-left"></span>
									</a></li>
							</ul>
						</div>
													...
													<div class="row">
														...
														<div class="col-12 col-sm-12 col-md-12 col-lg-12">
															<div class="form-item">
																...
																<span class="errors"
																	style="color:red;">${errors.coursetitle}</span>
															</div>
														</div>
														<div class="col-12">
															<hr>
															...
															<div class="form-item">
																...
																<div class="input-select">
																	<select class="el-select2-select-hour"
																		name="expertiseid" required>
																		<option value="">&nbsp;</option>
																		<option <c:if test='${expertiseid == 2001}'>
																			selected</c:if> value="2001">TOEIC</option>
																		<option <c:if test='${expertiseid == 2002}'>
																			selected</c:if> value="2002">TOEFL</option>
																		<option <c:if test='${expertiseid == 2003}'>
																			selected</c:if> value="2003">IELTS</option>
																		<option <c:if test='${expertiseid == 2004}'>
																			selected</c:if> value="2004">GEPT</option>
																		<option <c:if test='${expertiseid == 2005}'>
																			selected</c:if> value="2005">兒童美語</option>
																	</select>
																	<span class="errors"
																		style="color:red;">${errors.expertiseid}</span>
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-12 col-md-3">
															<div class="form-item">
																<label for="input-type"
																	class="form-label">課堂總堂數：</label>
																<div>
																	<input
																		onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"
																		type="number" name="classamount"
																		value="${param.classamount}">
																	<span class="errors"
																		style="color:red;">${errors.classamount}</span>
																</div>
															</div>
														</div>
														<div class="col-12 col-sm-12 col-md-3">
															<div class="form-item">
																...
																<div>
																	<input
																		...
																		value="${param.price}">
																	<span class="errors"
																		style="color:red;">${errors.price}</span>
																</div>
															</div>
														</div>
														<div class="col-12">
														...
														<div class="col-12 col-sm-12 col-md-12 pt-15">
															<div class="form-item">
																...
																<textarea
																	name="courseintro">${param.courseintro}</textarea>
																<span class="errors"
																	style="color:red;">${errors.courseintro}</span>
															</div>
														</div>
