		...
		<div class="container">
			<div class="header-wrap">
				...
				<div class="header-logo">
					<a href="/tfa105g5-more-than-educate/index.jsp"
				...
				<div class="header-links">
					<a href="/tfa105g5-more-than-educate/views/member/register.jsp"
						class="button button-md button-line-primary"> <span
						class="title">註冊</span>
					</a> <a href="/tfa105g5-more-than-educate/views/member/login.jsp"
						class="button button-md button-primary"> <span class="title">登入</span>
					</a>
					<form action="/tfa105g5-more-than-educate/views/member/logout"
						method="post">
...
<!-- 					<form action="/tfa105g5-more-than-educate/course/shoppingCart" method="post"> -->
					<input type="hidden" name="memid" value="${member.memid}">
						<a href="http://localhost:7080/tfa105g5-more-than-educate/views/course/CourseShoppingCart.html">
							<img src="<%=request.getContextPath()%>/public/shopping-cart1.ico" style="width:40px; height:35px;">
						</a>
						<a href= "http://localhost:7080/tfa105g5-more-than-educate/views/course/CourseShoppingCart.html">
							<img src="<%=request.getContextPath()%>/public/shopping-cart2.ico" style="width:40px; height:35px;">
						</a>
<!-- 					</form> -->
				</div>
			</div>
		...
		<div class="page page-course">
			...
			<section class="section section-course">
				<figure class="section-shape shape-2">
					<img class="img-fluid" src="assets/images/shapes/2.svg"
...
<!-- 														</li> -->
													...
													<img src="course/getMemberImg?courseid=${course.courseid}" alt="teacher avatar">
													</a>
												</div>
												<p class="title">
													<a href="page-teacher.html" target="_blank"> <span>${course.username}</span>
													</a>
												</p>
											...
											<button class="button button-md button-block button-primary btn_addCart ">
		...
		<script>
				...
				$(".btn_addCart").on( "click",e => {
					if("${member.memid}" && "${course.courseid}" == null){
