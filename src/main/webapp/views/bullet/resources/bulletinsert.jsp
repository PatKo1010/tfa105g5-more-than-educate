...
<body>
	...
	<body>
		...
		<form action="<c:url value='/bulletinsert.controller' />" method="get">
			<table>

				<tr>
					<td style="width: 110px;">布告欄標題 :</td>
					<td><input type="text" name="bulletTitle"
						value="${param.bulletTitle}"></td>
					<td><span class="error">${errors.bulletTitle}</span></td>
				</tr>
				<tr>
					<td style="width: 110px;">布告欄內文 :</td>
					<td><input type="text" name="bulletContent"
						style="line-height: 2em;" value="${param.bulletContent}"></td>
					<td><span class="error">${errors.bulletContent}</span></td>
				</tr>

				<tr>
					<td><input type="submit" name="BulletBean" value="Insert">
					</td>
		...
		<c:if test="${not empty insert}">
			...
			<table border="1">
				<tr>
					<td>布告欄編號</td>
					<td>${insert.bulletId}</td>
				</tr>
				<tr>
					<td>管理員帳號</td>
					<td>${login.adminEmail}</td>
				</tr>
				<tr>
					<td>布告欄抬頭</td>
					<td>${insert.bulletTitle}</td>
				</tr>
				<tr>
					<td>布告欄內容</td>
					<td>${insert.bulletContent}</td>
				</tr>
			</table>
		</c:if>
		<script
