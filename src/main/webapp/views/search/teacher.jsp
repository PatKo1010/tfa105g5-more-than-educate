                    ...
                    <div class="el-card card-course">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="card-title">
                                <h3>
                                    <a href="page-course.html">
                                        <span class="member3title">${members3.username} ${course.coursetitle} </span>
                                        <span class="subtitle text-color">${course.classamount}堂課總共${course.price}元</span>
                                    </a>
                                </h3>
                            </div>
                            <div class="card-body">
