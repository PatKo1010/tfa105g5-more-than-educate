				...
				<div class="display-spacing display-spacing-double">
					...
					<img class="person2"
						...
						<div class="membertitle2">老師名字和頭銜</div>				
								<div class="introduction2">這個是自我介紹</div>		
						<img class="favorimg2"
											src="https://pic.sucaibar.com/pic/201307/08/028acf7310.png">
						<span class="onebyone">一對一課程<span>
						<span class="money">NT</span>
						<span class="classamount">12堂課</span>
						<div class="selfbotton2">
										<button class="contact2">聯繫老師</button>
									</div>
						<div class="resume">工作經驗</div>
					<div class="educatebackground">學歷背景</div>
					
					<div class="comment2">120筆課程評價</div>
					<div class="studentimg">6666</div>
					<div class="date">12年1月23日</div>
