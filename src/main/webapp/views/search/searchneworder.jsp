					...
					<ul>
						<li class="has-menu" data-megamenu-link="mega-menu-1">
							<div class="mega-menu-link">
								<span class="title">Languages</span> <span
								...
								<div class="mega-menu-inner">
									<div>
										<div class="megamenu-info mb-15">
											<p class="text-center mb-30">Lorem, ipsum dolor sit amet
										...
										<div class="row row-lg-5 row-xl-5">
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/uk.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/germany.svg" alt="alt"> <span
														class="title">Germany</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/france.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/italy.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/spain.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/portugal.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/china.svg" alt="alt"> <span
														class="title">Mandarin</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/japan.svg" alt="alt"> <span
														class="title">Japanese</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/russia.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/india.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/arabic.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/iran.svg" alt="alt"> <span
														class="title">Persian</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/turkey.svg" alt="alt"> <span
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/vietnam.svg" alt="alt"> <span
														class="title">Vietnamese</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
											...
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/poland.svg" alt="alt"> <span
														class="title">Polish</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/israel.svg" alt="alt"> <span
														class="title">Hebrew</span>
													</a>
												</div>
											</div>
											<div class="col el-flag">
												<div class="inner">
													<a href="page-departements.html"> <img
														src="assets/images/flags/bangladesh.svg" alt="alt">
						...
						<li class="has-menu" data-megamenu-link="mega-menu-2">
							<div class="mega-menu-link">
								<span class="title">All Pages</span> <span
									class="icon fa fa-angle-left"></span>
							</div>
										...
										<div class="espard-menu">
											<div class="row row-xl-5">
												...
												<div class="col">
													<p class="title">Quick Access</p>
													<ul>
														<li><a href="page-teacher.html"> <span
																class="text">Teacher</span>
														</a></li>
														<li><a href="page-teachers.html"> <span
																class="text">List of Teachers</span>
														</a></li>
														<li><a href="page-course.html"> <span
																class="text">Course Details</span>
														</a></li>
														<li><a href="page-courses.html"> <span
																class="text">List of Courses</span>
														</a></li>
													</ul>
												</div>
												<!--/-->
												...
												<div class="col">
													...
													<ul>
														...
														<li><a href="teacher/dashboard-classrooms.html">
						...
						<li><a href="page-cooperation.html"> <span class="text">Join
									Now!</span> <span class="icon fa fa-angle-left"></span>
						</a></li>
					</ul>
				</div>
				<div class="header-logo">
					<a href="home.html" class="primary-logo"> <span class="text-1">Edu</span>
						...
						<div class="sysRecBar">
							<c:forEach var="member2" items="${members2}">
								<div class="bar1">
									...
									<div class="membertitle" onclick="direct(${member2.memid})"
										onmouseover="mouseover(event)" onmouseout="mouseout(event)">${member2.username}
										${member2.teatitle}</div>
									<div class="comment">
										<img
											src="<%=request.getContextPath()%>/public/images/star.png"
											class="starimg"> ${member2.ratesum} ·
										${member2.ratecount}個評論
									</div>

									<div class="introduction1">${member2.introcontent}
										${member2.photo} ${member2.regdate}</div>
