...
<html>
<head>
<title>MoreThanEducate 管理員</title>
<meta charset="UTF-8" />
					...
					<ul>
						<li class="has-menu" data-megamenu-link="mega-menu-1">
							<div class="mega-menu-link">
								<span class="title">管理員</span> <span
...
<form action="<c:url value='/adminLogin.controller' />" method="post">
<table>
	...
	<tr>
		<td>
			<input type="submit" name="adminBean" value="login">
		</td>
		<td>
...
<h3><a href="javascript:window.history.go(-1);">點此返上一頁</a></h3>
</body>
</html>